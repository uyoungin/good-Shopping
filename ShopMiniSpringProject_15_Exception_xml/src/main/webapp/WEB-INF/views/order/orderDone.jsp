...
<table width="70%" cellspacing="0" cellpadding="0">
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td height="35" class="td_default" align="center">
						<span id = "num1"></span>${oDTO.gAmount}개
					</td>
					<td height="35" class="td_default" align="center">
						<span>${oDTO.gPrice}</span>원
					</td>
				</tr>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<input type = 'text' id = 'total' value = '${oDTO.gPrice}' readonly>원
					</td>
				</tr>
				<tr>
	...
	<tr>
		<td class="td_default" align="center"><a class="a_default btn btn-primary" 
