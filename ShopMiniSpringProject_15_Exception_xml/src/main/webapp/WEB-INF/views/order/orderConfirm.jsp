	...
	$(document).ready(function(){
		...
		$("#same").click(function() {
			if (this.checked) {
				...
				$("#orderName").val("");
				$("#sample4_postcode").val($("").val());
				$("#sample4_roadAddress").val($("").val());
				$("#sample4_jibunAddress").val($("").val());
				$("#phone").val($("").val());
			}
		});
	});
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="1"
				...
				<tr>
					...
					<td height="35" class="td_default">
						...
						<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기" class="updateBtn btn btn-outline-primary"><br>
...
<!--  배송지 정보 끝-->
	...
	<tr>
		<td class="td_default" align="center">
			...
			<input type='button' value='취소' onclick="javascript:history.back()" class="btn btn-primary">	
		</td>
	</tr>
